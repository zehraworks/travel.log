...
export default function SignIn() {
  return (
    <div className="flex bg-background full-height">
      ...
      <div className="flex flex-col items-center text-center w-[440px] h-auto my-4 bg-primary text-primary-foreground px-16 py-16 mx-auto space-y-5 rounded-bl-sm rounded-tr-sm rounded-br-4xl rounded-tl-4xl border-[1.5px] border-primary-foreground">
